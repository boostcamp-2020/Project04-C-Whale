...
const message = {
  // 400
  TYPE_ERROR: () => '올바르지 않은 입력이 있습니다. 데이터 타입을 확인해주세요.',
  NECESSARY_INPUT_ERROR: () =>
    '필요한 데이터가 누락되었습니다. API 명세에 따라 필요한 데이터로 요청해주세요.',
  UNNECESSARY_INPUT_ERROR: () =>
    '불필요한 데이터가 포함되어있습니다. API 명세에 따라 요구하는 데이터만 입력해주세요.',
  INVALID_INPUT_ERROR: () =>
    `요청하신 데이터의 일부 값이 유효하지 않습니다. 데이터의 값을 확인해주세요`,
